...
class TracesReader:
    ...
    def read_traces(self, filename: str) -> Traces:
        file = _read_segy(get_example_file(filename), unpack_trace_headers=True)
        interval = file[0].stats.segy.trace_header["sample_interval_in_ms_for_this_trace"] / 1000
        ...
        return Traces(interval, amount_samples, (amount_samples - 1) * interval, traces)
