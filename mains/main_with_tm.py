import emission_tomography.CoherentSummationModule as CohSum
...
result = CohSum.CoherentSummation().compute_emission_tomography_with_tensor_moment(traces.traces, 
											travel_time, 
											receivers_coords, 
											region.list_of_source, 
											tensor_matrix, 1, 
											)
#result =  CohSum.CoherentSummation().compute_emission_tomography_without_tensor_moments(traces.traces, travel_time,1)
